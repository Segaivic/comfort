    ...
    <div class="row">
        ...
        $this->widget('ext.redactor.ERedactorWidget',array(
            ...
            'options'=>array(
                ...
                'lang'=>'ru',
                'fileUpload'=>Yii::app()->createUrl('/admin/page/fileUpload',array(
                    'attr'=>$model->content
                )),
                'fileUploadErrorCallback'=>new CJavaScriptExpression(
                    'function(obj,json) { alert(json.error); }'
                ),
                'imageUpload'=>Yii::app()->createUrl('/admin/page/imageUpload',array(
                    'attr'=>$model->content
                )),
                'imageGetJson'=>Yii::app()->createUrl('/admin/page/imageList',array(
                    'attr'=>$model->content
                )),
