...
class SAttrs extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
            ...
            'attrTitles'=>array(self::BELONGS_TO, 'AttributeTitles', 'attribute_id' , 'order'=>'pos ASC'),
            'attrValues'=>array(self::BELONGS_TO, 'Attrvalue', 'attr_valueid'),
		);
	}
...
//            первая итерация
    ...
    public static function checkAttributes($product_id , $attribute_id , $attr_value){
        $attributes = array();
        $model = self::model()->find(array(
            'condition' => 'product_id = :product_id AND attribute_id = :attribute_id AND attr_value = :attr_value',
            'params' => array(':product_id' => $product_id , ':attribute_id' => $attribute_id , ':attr_value' => $attr_value),
        ));
