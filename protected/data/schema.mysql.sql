...
CREATE TABLE IF NOT EXISTS `tbl_menu` (
  ...
  `is_root` enum('1','0') DEFAULT '1',
  `root_id` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

# Dumping data for table cms.tbl_menu: ~5 rows (approximately)
/*!40000 ALTER TABLE `tbl_menu` DISABLE KEYS */;
INSERT INTO `tbl_menu` (`id`, `title`, `access`, `link`, `pos`, `is_root`, `root_id`) VALUES
	(1, 'Главная', '1', '/', 1, '1', 0),
	(2, 'Новости', '1', '/news', 2, '1', 0),
	(3, 'О компании', '1', '/about-us', 3, '1', 0),
	(4, 'Субменю1', '1', '#', 2, '0', 2),
	(8, 'Субменю3', '1', '#', 1, '0', 2);
...
# Dumping data for table cms.tbl_news: ~19 rows (approximately)
...
INSERT INTO `tbl_news` (`id`, `title`, `alias`, `introtext`, `fulltext`, `is_published`, `is_onfrontpage`, `user_id`, `catid`, `created`, `modified`, `metakey`, `metadesc`) VALUES
	...
	(10, 'Стефан Эль-Шаровик', '', '<p></p><p><img src="/uploads/news//064cedee0bbd42b05cb2511018f91a3b.jpg" style="width: 122px; height: 279px; float: left; margin: 0px 10px 10px 0px;" alt=""></p>Стефан Карим Эль-Шаарави (итал. Stephan Kareem El Shaarawy; 27 октября 1992, Савона) — итальянский и египетский футболист, нападающий «Милана» и сборной Италии<br><p></p>\n<p><br></p><p><br></p><p><br></p><p><br></p><p><br></p><p><br></p>', '<h4 style="">Карьера</h4><p>Стефан Эль-Шаарави — сын&nbsp;<a href="http://ru.wikipedia.org/wiki/%D0%95%D0%B3%D0%B8%D0%BF%D1%82%D1%8F%D0%BD%D0%B5">египтянина</a>&nbsp;и&nbsp;<a href="http://ru.wikipedia.org/wiki/%D0%98%D1%82%D0%B0%D0%BB%D1%8C%D1%8F%D0%BD%D1%86%D1%8B">итальянки</a>. Он начал заниматься футболом в футбольной академии Леджино, откуда перешёл в молодёжный состав клуба «<a href="http://ru.wikipedia.org/wiki/%D0%94%D0%B6%D0%B5%D0%BD%D0%BE%D0%B0">Дженоа</a>» пропр<br></p><p style="text-align: center;"></p><p style="text-align: center"><img src="/uploads/page//435cd9c9bb39cdf05528a23ea94e0190.png" style=""></p><p></p><p style="text-align: center; "><br></p><p style="">Всё</p>', '1', '1', 1, 2, '2013-02-13 10:26:20', '2013-02-15 03:51:34', '', '');
...
# Dumping data for table cms.tbl_page: ~2 rows (approximately)
...
INSERT INTO `tbl_page` (`id`, `title`, `content`, `metakey`, `metadesc`, `updated_at`, `is_published`) VALUES
	(1, 'О компании', 'Продаем машины', NULL, NULL, '2013-02-11 10:05:05', '1'),
	(4, 'Контактная информация', '', '', '', '2013-02-12 11:40:28', '1');
...
INSERT INTO `tbl_users` (`id`, `username`, `password`, `email`, `activkey`, `superuser`, `status`, `create_at`, `lastvisit_at`) VALUES
	(1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'webmaster@example.com', '9b94c7be573c22b9d4f7f8caccd5043d', 1, 1, '2013-02-06 10:47:38', '2013-02-13 04:25:44'),
	(2, 'sega', '81dc9bdb52d04dc20036dbd8313ed055', 'hz@hz.hz', '7f76247eba0c1c34ac4de2e7863e95a3', 0, 1, '2013-02-13 05:04:05', '2013-02-13 06:08:12');
